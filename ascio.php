...
function ascio_GetContactDetails($params) {
	...
	$values["Registrant"]["Company Name"]  = $result->Registrant->OrgName;
	$values["Registrant"]["Address 1"]  = $result->Registrant->Address1;
	$values["Registrant"]["Address 2"]  = $result->Registrant->Address2;
	$values["Registrant"]["City"]  = $result->Registrant->City;
	$values["Registrant"]["State/Region"]  = $result->Registrant->State;
	...
	$values["Admin"]["Company Name"]  = $result->Admin->OrgName;
	$values["Admin"]["Address 1"]  = $result->Admin->Address1;
	$values["Admin"]["Address 2"]  = $result->Admin->Address2;
	$values["Admin"]["City"]  = $result->Admin->City;
	$values["Admin"]["State/Region"]  = $result->Admin->State;
	$values["Admin"]["Phone Number"]  = $result->Admin->Phone;
	$values["Admin"]["Email"]  = $result->Admin->Email;
	$values["Tech"]["First Name"] 		= $result->Tech->Firstname;
	$values["Tech"]["Last Name"] 		= $result->Tech->Lastname;
	$values["Tech"]["Company Name"]  = $result->Admin->OrgName;
	$values["Tech"]["Address 1"]  = $result->Admin->Address1;
	$values["Tech"]["Address 2"]  = $result->Admin->Address2;
	$values["Tech"]["City"]  = $result->Admin->City;
	$values["Tech"]["State/Region"]  = $result->Admin->State;
	$values["Tech"]["Phone Number"]  = $result->Admin->Phone;
	$values["Tech"]["Email"]  = $result->Admin->Email;
