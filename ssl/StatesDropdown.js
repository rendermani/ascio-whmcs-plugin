...
function statechange(element) {
    ...
    if (states[country]) {
        ...
        stateParent.append('<select name="state" class="' + stateInput.attr("class") + addClass + '" id="'+type+'StateSelect"' + statesTab + disabled + '><option value="">&mdash;</option>' + stateops + '</select>');
        var required = true;
